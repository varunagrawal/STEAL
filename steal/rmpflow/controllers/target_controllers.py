...
class TargetForceControllerUniform(NaturalGradientDescentForceController):
    ...
    def __init__(self,
        ...
        G = ScaledUniformMetric(w_u=self.w_u_,
                                w_l=self.w_l_,
                                sigma=self.sigma_,
                                device=device)  # Note: G doesnt depend on xd
...
class TargetForceControllerStretched(NaturalGradientDescentForceController):
    ...
    def __init__(self,
        ...
        G = DirectionallyStretchedMetric(w_u=self.w_u,
                                         w_l=self.w_l,
...
# ------------------------------------------------
class TargetMomentumControllerStretched(
